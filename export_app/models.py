...
class Page(models.Model):
    ...
    def save_iframe_code(self):
        ...
        self.iframe = '<script type="text/javascript">$.getScript("https://cdn.jsdelivr.net/npm/iframe-resizer@3.6.1/src/iframeResizer.min.js")</script><iframe onload="iFrameResize({log:true}, "{}")" src="{}" id="{}" width="100%" frameborder="0" scrolling="no"></iframe>' \
