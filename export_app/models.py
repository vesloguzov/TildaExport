...
class Page(models.Model):
    ...
    def save_iframe_code(self):
        self.iframe = '<iframe src="{}" width="740" frameborder="0" scrolling="no" onload="this.contentWindow.document.body.scrollHeight + "px""></iframe>'.format("http://будетпозже.рф"+self.page_path)
        pass
